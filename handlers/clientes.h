...
int get_TdP_clients(int row, char *TdP);// funcion para obtener el tipo de persona del cliente en el archivo.txt
int get_date_clients(int row, char *TdP);// funcion para obtener la fecha de creacion del cliente en el archivo.txt
